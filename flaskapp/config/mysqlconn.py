...
class MySQLConnection:
    def __init__(self, db):
        connection = pymysql.connect(host='<hostlink>',
                                     user='<username>',  # change the user and password as needed
                                     password='<password>',
                                     db=db,
                                     charset='utf8mb4',
    ...
    def query_db(self, query, data=None):
        with self.connection.cursor() as cursor:
            ...
            # this connectToMySQL function creates an instance of MySQLConnection, which will be used by application.py
